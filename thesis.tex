...
%
%公开版
\documentclass[PhD,otf]{nudtpaper}
%盲评版
%\documentclass[anon]{nudtpaper}
\usepackage{mynudt}
\usepackage{url}
%new added package
\usepackage{listings}
...
%\zhdate{\zhtoday}
\zhdate{二〇一七年十一月}
\entitle{Study on Key Technology for Automatic Vulnerability Detection of Souce Code Software}
