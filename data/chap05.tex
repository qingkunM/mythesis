...
\begin{figure}[htb]
\begin{center}
\includegraphics[scale=1.2]{chap05/示例程序1符号执行树}
\end{center}
\caption{示例程序1符号执行树}
\label{exam1-se-tree}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics{chap05/结合静态分析的符号执行技术框架}
...
\begin{figure}[htp]
\centering
\includegraphics[scale=1.2]{chap05/示例程序2符号执行树}
\caption{示例程序2符号执行树}
\label{fig-tree2}
\end{figure}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[scale=1.4]{chap05/符号执行变换后的程序}
\end{center}
\caption{符号执行变换后的程序}
\label{符号执行变换后的程序}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=1.4]{chap05/结合静态程序分析的高效符号执行技术实验过程}
...
%\begin{figure}[h]
%	\centering
%	\includegraphics{figures/chap05/{log_unsafe.time}.pdf}
%	\caption{运行时间总体曲线图}
%	\label{fig-time1}
%\end{figure}
%
%\begin{figure}[h]
%	\centering
%	\includegraphics{figures/chap05/{log_unsafe-scatter.plain.ic3.time}.pdf}
%	\caption{运行时间散点对比图}
%	\label{fig-time2}
%\end{figure}
...
%\begin{figure}[h]
%	\centering
%	\includegraphics{figures/chap05/{log_unsafe_node.number_of_nodes_created}.pdf}
%	\caption{内存消耗总体曲线图}
%	\label{fig-memory}
%\end{figure}
